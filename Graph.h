...
class Graph {
    private:
        // <node u, tuple<total distance, prev node, done, unordered_map<node v, uv edge weight>>>
        unordered_map<string, tuple<double, string, bool, unordered_map<string, double>>> graph_map;
